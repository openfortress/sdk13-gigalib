    ...
    // LINUX
        ...
        */
...
#ifdef PLATFORM_64BITS
        {
            ...
            // 55 48 89 e5 41 57 41 56 41 55 41 54 49 89 f4 53 48 89 fb 48 81 ec 18 01 00 00 0f b6 05 ?? ?? ?? ?? 84 c0 74 5b 48 8b 05 ?? ?? ?? ??
            AY_OBFUSCATE("\x55\x48\x89\xE5\x41\x57\x41\x56\x41\x55\x41\x54\x49\x89\xF4\x53\x48\x89\xFB\x48\x81\xEC\x18\x01\x00\x00\x0F\xB6\x05\x2A\x2A\x2A\x2A\x84\xC0\x74\x5B\x48\x8B\x05\x2A\x2A\x2A\x2A"),
            44,
            0x5B,
            PATCH_IMMEDIATE,
        ...
        // 55 48 89 e5 41 57 41 56 41 55 49 89 fd 41 54 49 89 f4 53 89 cb 48 83 ec 28 4c 8d 3d ?? ?? ?? ?? 89 55 bc 48 8d 15 ?? ?? ?? ??
        // 
        // offsets for the ConMsgs in this func are
        // 0x19C
        // 0x1BA
        ...
        #ifdef PLATFORM_64BITS
        {
            AY_OBFUSCATE("\x55\x48\x89\xE5\x41\x57\x41\x56\x41\x55\x49\x89\xFD\x41\x54\x49\x89\xF4\x53\x89\xCB\x48\x83\xEC\x28\x4C\x8D\x3D\x2A\x2A\x2A\x2A\x89\x55\xBC\x48\x8D\x15\x2A\x2A\x2A\x2A"),
            42,
            0x19C,
            PATCH_IMMEDIATE,
            AY_OBFUSCATE("\x90\x90\x90\x90\x90") // CALL -> NOP NOP NOP NOP NOP
